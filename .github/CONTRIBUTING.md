# Contributing to worldmet

This outlines how to propose a change to `{worldmet}`. 
...
*   Fork the package and clone onto your computer. If you haven't done this before, we recommend using `usethis::create_from_github("openair-project/worldmet", fork = TRUE)`.
...
Please note that the `{worldmet}` project is released with a
