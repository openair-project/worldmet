...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("openair-project/worldmet", fork = TRUE)`.
...
[worldmet](https://openair-project.github.io/worldmet/) project is
released with a [Contributor Code of
Conduct](https://openair-project.github.io/worldmet/CODE_OF_CONDUCT.md).
